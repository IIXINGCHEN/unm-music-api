...
[![Version](https://img.shields.io/badge/version-v4.0.0-sky.svg?style=flat-square)](https://github.com/IIXINGCHEN/unm-music-api/releases)
...
### 7. 系统状态与监控大盘 API
- `GET /info`：获取服务基础信息、版本 (`4.0.0`) 及当前启用的可用音源列表。
